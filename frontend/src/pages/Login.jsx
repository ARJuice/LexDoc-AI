...
export default function Login() {
    ...
    return (
        <div ref={pageRef} className="login-page">
            {/* Background elements handled by global CSS */}
            ...
            <div className="login-container">
                <div className="login-card liquid-glass-card">
                    ...
                    <div className="login-body">
                        ...
                        <div className="login-domain-info">
                            <Info size={16} />
                            <span>Please use your <strong>@sahrdaya.ac.in</strong> account to sign in.</span>
                        </div>
                    </div>

                    <div className="login-footer">
                        Secure AI-powered document management for Sahrdaya College of Engineering and Technology.
                    </div>
                </div>
            </div>
        </div>
